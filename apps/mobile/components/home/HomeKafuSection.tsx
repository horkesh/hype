...
const styles = StyleSheet.create({
  ...
  ctaButton: { backgroundColor: '#8E2DE2', paddingVertical: 12, borderRadius: 16, alignItems: 'center' },
  ...
  rerollText: { color: '#8E2DE2', fontSize: 14, fontWeight: '600', fontFamily: 'DMSans_700Bold' },
});
