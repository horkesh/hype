...
1. continue screen simplification and route stability on the next largest shared routes now that Explore and Tonight are both collapsed into shared helper/component structures
